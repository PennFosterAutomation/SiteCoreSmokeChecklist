...
public class EOLDomesticReceiveInfo_Test {
	...
	{		
		Reporter.log(Utilities.logOutputFile(" ########## Start Enter Student Information On Step1 Page STARTS ###########"));
		  ...
		  Fname = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.FirstName");
		  Lname = Utilities.getFname();
		  Mail = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.Email");
		  EmailExt = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.EmailExt");
		  Phone = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.PrimaryPhone");
		  Address = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.Address");
		  City = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.City");
		  State = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.State");
		  Zip = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.ZIP");
	...
	{		
		...
		String DOBmonth = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.DOBmonth");
		 String DOBday = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.DOBday");
		 String DOByear = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.DOByear");
	...
	{		
		...
		CreditCardNumber = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.CreditCardNumber");
		CVV = test.getYamlVal("DomesticURLReceiveInformation.StudentInformation.CVV");
