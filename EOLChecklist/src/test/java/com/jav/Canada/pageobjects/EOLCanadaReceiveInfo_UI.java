...
public class EOLCanadaReceiveInfo_UI extends AbstractClass {

    WebDriver driver;
    String course;

    public EOLCanadaReceiveInfo_UI(WebDriver driver) {
        
        super(driver);
        this.driver = driver;
    }
    @FindBy(xpath = "//form[@id='form6']/a")
    protected WebElement CanadaURLReceiveInformation;
...
//		########### Message validation Payment Information Page  ######################
    ...
    public void navigateToCanadaURLReciveInformation() {
        CanadaURLReceiveInformation.click();
        Reporter.log(Utilities.logOutputFile("Click on Receive Information - Pass"));
    ...
    public void varifyPageElementsForStep1() {
        ...
        try {
            ...
            Assert.assertTrue(courseNameHeadingOnStep1Page.getText().equalsIgnoreCase("HIGH SCHOOL"));
            Assert.assertTrue(courseMainNameHeadingOnStep1Page.getText().equalsIgnoreCase("HIGH SCHOOL"));
...
//			#####################################################
    ...
    public void verifyThnakYouPageAfterStep1FormPage() {
        ...
        Reporter.log(Utilities.logOutputFile("Verify thank you page displayed  - PASS "));
    ...
    public void verifyPersonalInformationPage() {
        try {
            ...
            Assert.assertTrue(firstNameTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(firstNameTextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(firstNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.FirstName")));
            Assert.assertTrue(lastNameTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(lastNameTextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(lastNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(lname));
            Assert.assertTrue(emailTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(emailTextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(emailTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(email + "@" + Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.EmailExt")));
            Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(reTypeEmailTextBoxLabelOnStep1Page.isDisplayed());
            System.out.println("email is : " +reTypeEmailTextBoxOnStep1Page.getAttribute("value"));
            Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(email + "@" + Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.EmailExt")));
            Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(primaryPhoneTextBoxLabelOnStep1Page.isDisplayed());
            System.out.println("primary phone is " +primaryPhoneTextBoxOnStep1Page.getAttribute("value"));
            Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.PrimaryPhone")));
            Assert.assertTrue(address1TextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(address1TextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(address1TextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.Address")));
            Assert.assertTrue(address2TextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(address2TextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(cityTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(cityTextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(cityTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.City")));
            Assert.assertTrue(ProvinceTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(ProvinceTextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(PostalCodeTextBoxOnStep1Page.isDisplayed());
            Assert.assertTrue(PostalCodeTextBoxLabelOnStep1Page.isDisplayed());
            Assert.assertTrue(PostalCodeTextBoxLabelOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.ZIP")));
            Assert.assertTrue(communicateViaEmailCheckbox.isDisplayed());
            Assert.assertTrue(communicateViaEmailCheckboxLabel.isDisplayed());
            Assert.assertTrue(communicateViaTextMsgCheckbox.isDisplayed());
            Assert.assertTrue(communicateViaTextMsgCheckboxLabel.isDisplayed());
...
//        secureTransactionImageFooterOnPaymentInformationPage.isDisplayed();
    ...
    public boolean selectfullpaymentmodeOnPaymentInformationPage() {
        ...
        if (str.contains("Please select your payment method:")
            ...
            if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode").equalsIgnoreCase("Checking or Savings Account")) {
    ...
    public void verifyElementOnCreditCardSectionOnPaymentInformationPage() {
        if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode").equalsIgnoreCase("Checking or Savings Account")) {
            ...
            try {
                ...
                Assert.assertTrue(textboxFirstNameCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.FirstName")));
                ...
                Assert.assertTrue(textboxAdderss1CreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.Address")));
                ...
                Assert.assertTrue(textboxCityCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.City")));
                ...
                System.out.println("actual pc "  +textboxPostalCodeCreditCardOnPaymentInformationPage.getAttribute("value").replace(" ", ""));
                System.out.println("expected pc " +Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.ZIP").replace(" ", ""));
                Assert.assertTrue(textboxPostalCodeCreditCardOnPaymentInformationPage.getAttribute("value").replace(" ", "").equalsIgnoreCase(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.ZIP").replace(" ", "")));
                Assert.assertTrue(textboxPostalCodeCreditCardOnPaymentInformationPage.isDisplayed());
                Assert.assertTrue(labelPostalCodeCreditCardOnPaymentInformationPage.isDisplayed());
    ...
    public void enterCreditCardInformationSectionOnPaymentInformationPage(String CreditCardNumber, String CVV) {
        ...
        if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode").equalsIgnoreCase("Checking or Savings Account")) {
            BankNumberTextPaymentInformationPage.sendKeys(Utilities.getYamlValue("CanadaURLReceiveInformation.BankNumber"));
            TransitNumberTextPaymentInformationPage.sendKeys(Utilities.getYamlValue("CanadaURLReceiveInformation.TransitNumber"));
            AccountNumberTextPaymentInformationPage.sendKeys(Utilities.getYamlValue("CanadaURLReceiveInformation.AccountNumber"));
            ...
            try {
                ...
                String zipCode = textboxPostalCodeCreditCardOnPaymentInformationPage.getAttribute("value");
                ...
                textboxPostalCodeCreditCardOnPaymentInformationPage.sendKeys(zipCode);
...
//            m = check.get(4);
//            Assert.assertTrue(m.getText().contains("AL"));
            ...
            m = check.get(9);
            Assert.assertTrue(m.getText().contains(Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.DOBmonth") + "/"
                    + Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.DOBday") + "/"
                    + Utilities.getYamlValue("CanadaURLReceiveInformation.StudentInformation.DOByear")));
            ...
            if (Utilities.getYamlValue("CanadaURLReceiveInformation.PaymentMode").equalsIgnoreCase("Credit or Debit Card")) {
                m = check.get(17);
                Assert.assertTrue(m.getText().contains("XXXXXXXXXXXX1111"));
            } else {
                m = check.get(17);
                System.out.println("#### " + m.getText());
                String accountnumber = Utilities.getYamlValue("CanadaURLReceiveInformation.AccountNumber");
