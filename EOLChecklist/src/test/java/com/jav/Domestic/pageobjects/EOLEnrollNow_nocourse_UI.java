...
import com.jav.Domestic.tests.AllCourse_EOLDomesticEnrollNow_nocourse_Tests;
import com.jav.Domestic.util.ReadWriteExcelFile;
import com.jav.Domestic.util.Utilities;


public class EOLEnrollNow_nocourse_UI  extends AbstractClass{
    ...
    public EOLEnrollNow_nocourse_UI(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
...
//		########### Message validation Payment Information Page  ######################
		...
		String email;
		String courseCost;
		int currentCourseUI = AllCourse_EOLDomesticEnrollNow_nocourse_Tests.initialCounter + 1;
		...
		public boolean  selectfullpaymentmodeOnPaymentInformationPage(){
					...
					str.contains("Today's Payment:"))
			{
				...
				if (Utilities.getYamlValue("DomesticURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
				{					
		...
		public void  verifyElementOnCreditCardSectionOnPaymentInformationPage()
		{
			...
			}catch(Exception e)
			{
				...
				Assert.assertTrue(textboxFirstNameCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.FirstName")));
				...
				Assert.assertTrue(textboxAdderss1CreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.Address")));
				...
				Assert.assertTrue(textboxCityCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.City")));
				...
				Assert.assertTrue(textboxZipCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.ZIP")));
...
//			if (Utilities.getYamlValue("DomesticURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
//			{
//				if(Utilities.getYamlValue("DomesticURLEnrollNownocourse.AccountType").equalsIgnoreCase("Checking"))
//				{
...
//				}
			...
			if (Utilities.getYamlValue("DomesticURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
			{
				if(Utilities.getYamlValue("DomesticURLEnrollNownocourse.AccountType").equalsIgnoreCase("Checking"))
				{
					Select select = new Select(accountTypesavingsAccountDropdownOnPaymentInformationPage);
					select.selectByValue("C");
					if (Utilities.getYamlValue("DomesticURLEnrollNownocourseRunType").equalsIgnoreCase("AllCources")){
				...
				routingNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("DomesticURLEnrollNownocourse.RoutingNumber"));
				accountNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("DomesticURLEnrollNownocourse.AccountNumber"));
...

{
			...
			try{
				...
				m = check.get(9);			
				Assert.assertTrue(m.getText().contains(Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.DOBmonth")+"/"+Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.DOBday")+"/"+Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.DOByear")));
				...
				if (Utilities.getYamlValue("DomesticURLEnrollNownocourse.PaymentMode").equalsIgnoreCase("Credit or Debit Card"))
				{
					m = check.get(17);
		...
		public boolean acceptTermandConditionOnReviewAndSubmitPage()
		{
			...
			try{
				...
				if(Utilities.getYamlValue("DomesticURLEnrollNownocourse.SignDocElectronically").equalsIgnoreCase("yes")) {
