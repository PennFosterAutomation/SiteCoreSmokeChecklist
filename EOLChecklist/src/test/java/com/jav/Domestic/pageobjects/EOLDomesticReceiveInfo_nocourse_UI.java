...
public class EOLDomesticReceiveInfo_nocourse_UI extends AbstractClass{
...
String course;
    ...
    public EOLDomesticReceiveInfo_nocourse_UI(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
...
//		######### Personal Information Page #################
		...
		@FindBy(xpath = "//a[contains(text(),'Continue to this website (not recommended).')]")
		protected WebElement CertificateonIE;
...
//		########### Message validation Payment Information Page  ######################
		...
		int currentCourseUI = AllCourse_EOLDomesticReceiveInfo_nocourse_Tests.initialCounter + 1;
		...
		public int getCourseCountFromPannFosterPage()
        {			
...
//			#############################################################################
		...
		public void verifyPersonalInformationPage()	
		{
			try
			{
				...
				Assert.assertTrue(firstNameTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(firstNameTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(firstNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.FirstName")));
				Assert.assertTrue(lastNameTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(lastNameTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(lastNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(lname));
				Assert.assertTrue(emailTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(emailTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(emailTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(email+"@"+Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.EmailExt")));
				Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(reTypeEmailTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(email+"@"+Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.EmailExt")));
				Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(primaryPhoneTextBoxLabelOnStep1Page.isDisplayed());
				...
				Assert.assertTrue(cityTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(cityTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(cityTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.City")));
				Assert.assertTrue(stateTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(stateTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(zipTextBoxOnStep1Page.isDisplayed());
				Assert.assertTrue(zipTextBoxLabelOnStep1Page.isDisplayed());
				Assert.assertTrue(zipTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.ZIP")));
				Assert.assertTrue(communicateViaEmailCheckbox.isDisplayed());					
				Assert.assertTrue(communicateViaEmailCheckboxLabel.isDisplayed());					
				Assert.assertTrue(communicateViaTextMsgCheckbox.isDisplayed());					
				Assert.assertTrue(communicateViaTextMsgCheckboxLabel.isDisplayed());					
...
//			secureTransactionImageFooterOnPaymentInformationPage.isDisplayed();
		...
		public boolean  selectfullpaymentmodeOnPaymentInformationPage(){
					...
					str.contains("Today's Payment:"))
			{
				...
				if (Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
				{					
		...
		public void  verifyElementOnCreditCardSectionOnPaymentInformationPage()
		{
			...
			}catch(Exception e)
			{
				...
				Assert.assertTrue(textboxFirstNameCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.FirstName")));
				...
				Assert.assertTrue(textboxAdderss1CreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.Address")));
				...
				Assert.assertTrue(textboxCityCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.City")));
				...
				Assert.assertTrue(textboxZipCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.ZIP")));
		...
		public void  enterCreditCardInformationSectionOnPaymentInformationPage(String CreditCardNumber, String CVV)
		{
			...
			if (Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
			{
				if(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.AccountType").equalsIgnoreCase("Checking"))
				{
					Select select = new Select(accountTypesavingsAccountDropdownOnPaymentInformationPage);
					select.selectByValue("C");
					if (Utilities.getYamlValue("DomesticURLReceiveInformationnocourseRunType").equalsIgnoreCase("AllCources")){
				...
				routingNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.RoutingNumber"));
				accountNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.AccountNumber"));
...

{
			...
			try{
				...
				m = check.get(9);			
				Assert.assertTrue(m.getText().contains(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.DOBmonth")+"/"
						+Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.DOBday")+"/"
						+Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.DOByear")));
							
				m = check.get(10);
				Assert.assertTrue(m.getText().contains(course));	
