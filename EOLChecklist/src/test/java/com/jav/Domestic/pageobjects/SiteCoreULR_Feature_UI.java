...
String course;
    ...
    public SiteCoreULR_Feature_UI(WebDriver driver) {
		...
		@FindBy(xpath = "//div[@id='ctl00_ctl00_MasterContentPlaceHolder_NestedMasterContentPlaceHolder_Form_div_ProgramName1']")
		protected WebElement defaultCourseName;
...
//		########### Message validation Payment Information Page  ######################
        ...
        {       
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ctl00_ctl00_MasterContentPlaceHolder_NestedMasterContentPlaceHolder_Form_div_ProgramName1']")));
			courseName = defaultCourseName.getText();
			//System.out.println("default course name is " +courseName);
        }
        ...
        {       
			...
			Assert.assertTrue(enrollNowLinkOnSiteCoreHomePage.isDisplayed());  			
			Assert.assertTrue(requestInfoLinkOnSiteCoreHomePage.isDisplayed());
			enrollNowLinkOnSiteCoreHomePage.click(); 
			Reporter.log(Utilities.logOutputFile(" Penn Foster School Image Verify - Pass"));
			WebDriverWait wait = new WebDriverWait(driver, 50);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ctl00_ctl00_MasterContentPlaceHolder_NestedMasterContentPlaceHolder_Form_div_ProgramName1']")));
			courseName = defaultCourseName.getText();
	...
	public void verifyPersonalInformationPage()	
	{
		try
		{
			...
			Assert.assertTrue(firstNameTextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.FirstName")));
			Assert.assertTrue(lastNameTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(lastNameTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(lastNameTextBoxOnStep1Page.getAttribute("value").equalsIgnoreCase(lname));
			Assert.assertTrue(emailTextBoxOnStep1Page.isDisplayed());
			...
			Assert.assertTrue(emailTextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(email+"@"+Utilities.getYamlValue("SiteCoreApp.StudentInformation.EmailExt")));
			Assert.assertTrue(reTypeEmailTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(reTypeEmailTextBoxLabelOnStep1Page.isDisplayed());
			...
			Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.PrimaryPhone")));
			Assert.assertTrue(address1TextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(address1TextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(address1TextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.Address")));
			Assert.assertTrue(address2TextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(address2TextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(cityTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(cityTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(cityTextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.City")));
			Assert.assertTrue(stateTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(stateTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(zipTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(zipTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(zipTextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.ZIP")));
			Assert.assertTrue(communicateViaEmailCheckbox.isDisplayed());					
			Assert.assertTrue(communicateViaEmailCheckboxLabel.isDisplayed());					
			Assert.assertTrue(communicateViaTextMsgCheckbox.isDisplayed());					
			Assert.assertTrue(communicateViaTextMsgCheckboxLabel.isDisplayed());					
...
//			okButtonValidationPopUp.click();
//		} catch (Exception e) {
//			//System.out.println("Ok button is not displayed" +e);
//		}
...
//		secureTransactionImageFooterOnPaymentInformationPage.isDisplayed();
	...
	public boolean  selectfullpaymentmodeOnPaymentInformationPage(){
				...
				str.contains("Today's Payment:"))
		{
			...
			if (Utilities.getYamlValue("SiteCoreApp.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
			{					
	...
	public void  verifyElementOnCreditCardSectionOnPaymentInformationPage()
	{
		...
		}catch(Exception e)
		{
			...
			Assert.assertTrue(textboxFirstNameCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.FirstName")));
			...
			Assert.assertTrue(textboxAdderss1CreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.Address")));
			...
			Assert.assertTrue(textboxCityCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.City")));
			...
			Assert.assertTrue(textboxZipCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("SiteCoreApp.StudentInformation.ZIP")));
	...
	public void  enterCreditCardInformationSectionOnPaymentInformationPage(String CreditCardNumber, String CVV)
	{
		...
		if (Utilities.getYamlValue("SiteCoreApp.PaymentMode").equalsIgnoreCase("Checking or Savings Account"))
		{
			if(Utilities.getYamlValue("SiteCoreApp.AccountType").equalsIgnoreCase("Checking"))
			{
			...
			routingNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("SiteCoreApp.RoutingNumber"));
			accountNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("SiteCoreApp.AccountNumber"));
...

{
		...
		try{
			...
			m = check.get(9);			
			Assert.assertTrue(m.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.DOBmonth")+"/"
					+Utilities.getYamlValue("SiteCoreApp.StudentInformation.DOBday")+"/"
					+Utilities.getYamlValue("SiteCoreApp.StudentInformation.DOByear")));
						
			m = check.get(10);
			//System.out.println(m.getText());
			Assert.assertTrue(m.getText().contains(courseName));	
			...
			if (Utilities.getYamlValue("SiteCoreApp.PaymentMode").equalsIgnoreCase("Credit or Debit Card"))
			{
				m = check.get(17);
				...
				m = check.get(17);
				//System.out.println("#### "+m.getText());
				String accountnumber = Utilities.getYamlValue("SiteCoreApp.AccountNumber");
	...
	public void acceptTermandConditionOnReviewAndSubmitPage()
	{
		...
		try{
			...
			Reporter.log(Utilities.logOutputFile(" Final Student ID is "+getStudentIDFromCongratulationsPage.getText()+" for recieve info - Pass"));
			...
			Reporter.log(Utilities.logOutputFile(" Final Student ID not genrated for Recieve info link, application display only is Congratulations page"));
			
		}			
		
	}
	
	public void acceptTermandConditionOnReviewAndSubmitPageForEnroll()
	{
		Assert.assertTrue(checkboxLabelTermandConditionOnReviewAndSubmitPage.isDisplayed());
		checkboxTermandConditionOnReviewAndSubmitPage.click();
		enrollTermandConditionOnReviewAndSubmitPage.click();
		...
		try{
			...
			yesLinkonDisplayOnElectronicSignature.isDisplayed();
			noLinkonDisplayOnElectronicSignature.isDisplayed();		
			if(Utilities.getYamlValue("SiteCoreApp.SignDocElectronically").equalsIgnoreCase("yes")) {
				...
				String FullName = Utilities.getYamlValue("SiteCoreApp.StudentInformation.FirstName")+ " "+Utilities.getYamlValue("SiteCoreApp.StudentInformation.LastName");
				try{
...
//				}
				...
				Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.Address").toUpperCase()));
				Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.City").toUpperCase()));
				Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.ZIP")));
				...
				Assert.assertTrue(EmailOnElectronicSigAgreement.getText().contains(email.toUpperCase()+"@"+Utilities.getYamlValue("SiteCoreApp.StudentInformation.EmailExt").toUpperCase()));										
				...
				textboxEmailOnElectronicSigAgreement.sendKeys(email+"@"+Utilities.getYamlValue("SiteCoreApp.StudentInformation.EmailExt"));
				...
				try{
					...
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());																		
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.FirstName").toUpperCase()));
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.Address").toUpperCase()));
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.City").toUpperCase()));
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("SiteCoreApp.StudentInformation.ZIP")));
					...
					Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(email.toUpperCase()+"@"+Utilities.getYamlValue("SiteCoreApp.StudentInformation.EmailExt").toUpperCase()));
				...
				try {
					clickHereLinkOnCongratulationsPage.isDisplayed();
					Reporter.log(Utilities.logOutputFile(" Final "+getStudentIDFromCongratulationsPage.getText()+" for Enroll Link - Pass"));
					
					//System.out.println("$$$$$$$$$$  Completed Student ID is --> "+getStudentIDFromCongratulationsPage.getText());
				} catch (Exception e) {
					System.out.println(e);
					Reporter.log(Utilities.logOutputFile(" Final "+StudentID+" - Pass"));
					Reporter.log(Utilities.logOutputFile("ID Generated and Exception Page displayed on final Enroll"));
			...
			noLinkonDisplayOnElectronicSignature.click();
			clickHereLinkOnCongratulationsPage.isDisplayed();
			Reporter.log(Utilities.logOutputFile(" Final Student ID is "+getStudentIDFromCongratulationsPage.getText()+" for enroll link - Pass"));
			...
			txtCongratulationsOnReviewAndSubmitPage.isDisplayed();
			Reporter.log(Utilities.logOutputFile(" Final Student ID not genrated for enroll link, application display only is Congratulations page"));
