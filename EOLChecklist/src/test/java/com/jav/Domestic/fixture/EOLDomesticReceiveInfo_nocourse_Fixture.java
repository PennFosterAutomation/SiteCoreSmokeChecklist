...
public class EOLDomesticReceiveInfo_nocourse_Fixture extends BaseFixture {
	...
	public void selectPaymentModeAndEnterCardInformation() {
		Assert.assertTrue(PanFoster
				.selectfullpaymentmodeOnPaymentInformationPage());
	}
	...
	public void enterCreditCardInformationAfterCreditCardSelection(
			String CreditCardNumber, String CVV) {
		PanFoster.enterCreditCardInformationSectionOnPaymentInformationPage(
