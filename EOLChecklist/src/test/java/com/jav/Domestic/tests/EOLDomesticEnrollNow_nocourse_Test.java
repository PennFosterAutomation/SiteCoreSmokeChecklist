...
public class EOLDomesticEnrollNow_nocourse_Test {
	...
	{		
		...
		CreditCardNumber = test.getYamlVal("DomesticURLEnrollNownocourse.StudentInformation.CreditCardNumber");
		CVV = test.getYamlVal("DomesticURLEnrollNownocourse.StudentInformation.CVV");
