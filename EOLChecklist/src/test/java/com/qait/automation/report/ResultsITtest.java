...
public class ResultsITtest {

    String testdata;
    Date today = new Date();
    String host = "mail.qainfotech.net";
    String from = "sumeetkumar@qainfotech.net";
    String password = "Sumeet18";
    String port = "587";
    ...
    void setupMailConfig() {
        if (getTestName().contains("Canada")){
            test.setUpDataFile("testData/integration_testData_Canada.yml");
        }else if (getTestName().contains("Domestic")){
    ...
    private Session getSession() {
        ...
        System.out.println("port is:  " +port.toString());
