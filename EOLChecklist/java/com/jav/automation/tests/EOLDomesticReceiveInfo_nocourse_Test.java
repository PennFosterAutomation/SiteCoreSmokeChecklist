...
public class EOLDomesticReceiveInfo_nocourse_Test {
    ...
    public void initialsettings() 
    {
        ...
        if (Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.RunType").equalsIgnoreCase("OneIteration")){
	...
	{		
		if (Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.RunType").equalsIgnoreCase("Selected")){
			...
			test.selectCourse(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.SelectCourse.Cource"+AllCourse_EOLDomesticReceiveInfo_nocourse_Tests.initialCounter));				
	...
	{		
		Reporter.log(Utilities.logOutputFile(" ########## Start Enter Student Information On Step1 Page STARTS ###########"));
		  ...
		  Fname = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.FirstName");
		  Lname = Utilities.getFname();
		  Mail = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.Email");
		  EmailExt = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.EmailExt");
		  Phone = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.PrimaryPhone");
		  Address = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.Address");
		  City = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.City");
		  State = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.State");
		  Zip = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.ZIP");
	...
	{		
		...
		String DOBmonth = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.DOBmonth");
		 String DOBday = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.DOBday");
		 String DOByear = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.DOByear");
	...
	{		
		...
		CreditCardNumber = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.CreditCardNumber");
		CVV = test.getYamlVal("DomesticURLReceiveInformationnocourse.StudentInformation.CVV");
