...
public class ResultsIT {
    ...
    public String setBodyText() throws IOException {
        ...
        if (className.contains("AllCourse_EOLDomesticReceiveInfo")){
            mailtext = mailtext + "<br><br>The detailed test results are given in the attached <i>Result.xls</i> </br></br>";
        }else{
...
//        if (Utilities.getYamlValue("RunType").equalsIgnoreCase("AllCources")){
...
//
//        }else{
//        	 if (Utilities.getYamlValue("RunType").equalsIgnoreCase("Selected")){
//        	        mailtext = mailtext + "<br><br>The detailed test results for selected courses are given in the attached <i>Result.xls</i> </br></br>";
//
//        	        }else{
//        	            mailtext = mailtext + "<br><br>The detailed test results are given in the attached <i>emailable-report.html</i> </br></br>";
//
