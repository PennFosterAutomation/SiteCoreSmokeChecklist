...
// Part two is attachment
    ...
    public void replaceEmailReport()
    {
    	...
    	if (getTestName().contains("SelectedCourse") || getTestName().contains("complete automation test suite") ){
        	try
            {
            ...
            String newtext = oldtext.replaceAll("Parameter #11", "GA Script"); 
            String renewtext = newtext.replaceAll("Parameter #2", "Program of Interest");
            
            newtext = renewtext.replaceAll("Parameter #3", "Course Name EOL");
            renewtext = newtext.replaceAll("Parameter #4", "SiteCore Form");        
            newtext = renewtext.replaceAll("Parameter #5", "Course Code");       
            renewtext = newtext.replaceAll("Parameter #6", "Phone Number");       
            newtext = renewtext.replaceAll("Parameter #7", "Time to Complete");       
            renewtext = newtext.replaceAll("Parameter #9", "Program");       
            newtext = renewtext.replaceAll("Parameter #10", "Phone Number Option");       
            ...
            newtext = renewtext.replaceAll("Parameter #8", "Chat Now");          
