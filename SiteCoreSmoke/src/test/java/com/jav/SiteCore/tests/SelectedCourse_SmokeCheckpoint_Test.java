...
public class SelectedCourse_SmokeCheckpoint_Test {
	...
	public Object[][] createData() {
		String[][] str = writeResult.removeRowFrom2dArray(
				writeResult.readExcelFileWithSpaces("Final", 11), 0);
		Object[][] retObjArr = str;
		return (retObjArr);
	}

	@Test(dataProvider = "DP1")
	public void CheckPoints(String coursename, String timetoComplete,
			String chatnow, String Program, String PhoneNumberOption,
			String GAScript, String SiteCoreForm, String PhoneNumber, String CourseCode, String programofinterest,
			String CnameEOL) throws InterruptedException {
	...
	public void verifyPhoneNumber(String PhoneNumber) {
		if (phonenumberOption.equalsIgnoreCase("Y")) {
			Reporter.log(Utilities
					.logOutputFile("   ########## Phone Number verifivation STARTS ###########"));
			test.verifyPhoneNumber(PhoneNumber);
			Reporter.log(Utilities
					.logOutputFile("   ########## Phone Number verifivation ENDS ###########"));
			Reporter.log(Utilities.blankLine(""));
			Reporter.log(Utilities.blankLine(""));
		}
	}
	...
	public void verifyGoogleAnalyticsScript(String CourseCode) {
		if (gaScript.equalsIgnoreCase("Y")) {
			Reporter.log(Utilities
					.logOutputFile("   ########## Verify Google Analytics Script STARTS###########"));
			test.verifyGoogleAnalyticsScript(CourseCode);
			Reporter.log(Utilities
					.logOutputFile("   ########## Verify Google Analytics Script ENDS ###########"));
			Reporter.log(Utilities.blankLine(""));
			Reporter.log(Utilities.blankLine(""));
	...
	public void verifyChatNowHeader() {
		if (chatNow.equalsIgnoreCase("Y")) {
			Reporter.log(Utilities
					.logOutputFile("   ########## Chat now header clicked STARTS ###########"));
			test.verifyChatNowHeader();
			Reporter.log(Utilities
					.logOutputFile("   ########## Chat now header clicked ENDS ###########"));
			Reporter.log(Utilities.blankLine(""));
			Reporter.log(Utilities.blankLine(""));
		}
	}
	...
	public void verifyChatNowFooter() {
		if (chatNow.equalsIgnoreCase("Y")) {
			Reporter.log(Utilities
					.logOutputFile("   ########## verify chat now footer STARTS ###########"));
			test.verifyChatNowFooter();
			Reporter.log(Utilities
					.logOutputFile("   ########## verify chat now footer ENDS ###########"));
			Reporter.log(Utilities.blankLine(""));
			Reporter.log(Utilities.blankLine(""));
		}
	}
	...
	public void verifyTimeToComplete() {
		...
		Reporter.log(Utilities
				.logOutputFile("   ########## Time to Complete STARTS ###########"));

			System.out.println("timeToCompleteinClass "
					+ SelectedCourse_SmokeCheckpoint_Test.timeToComplete);
		if (timeToComplete.equalsIgnoreCase("Y")) {
			Reporter.log(Utilities
					.logOutputFile("   ########## click time to complete button STARTS ###########"));
			test.clickTimeToCompleteBtn();
			Reporter.log(Utilities
					.logOutputFile("   ########## click time to complete button ENDS ###########"));

			Utilities.hardWait(4);

			System.out.println("Inside");
			Reporter.log(Utilities
					.logOutputFile("   ########################## Verify time to complete button STARTS ##########################"));

			Reporter.log(Utilities
					.logOutputFile("   ########## click extended radio button STARTS ###########"));
			test.clickExtendedRadioBtn(courseName);
			Utilities.hardWait(2);
			Reporter.log(Utilities
					.logOutputFile("   ########## click extended radio button ENDS ###########"));

			Reporter.log(Utilities
					.logOutputFile("   ########## verify summary details STARTS ###########"));
			test.verifySummaryDetails();
			Reporter.log(Utilities
					.logOutputFile("   ########## verify summary details ENDS ############"));

			Reporter.log(Utilities
					.logOutputFile("   ########## click standard radio button STARTS ###########"));
			test.clickStandardRadioBtn();
			Utilities.hardWait(2);
			Reporter.log(Utilities
					.logOutputFile("   ########## click standard radio button ENDS ###########"));
			...
			Reporter.log(Utilities
					.logOutputFile("   ########## click accelerated radio button STARTS ###########"));
			test.clickAcceleratedRadioBtn();
			Utilities.hardWait(2);
			Reporter.log(Utilities
					.logOutputFile("   ########## click accelerated radio button ENDS ###########"));
			...
			Reporter.log(Utilities
					.logOutputFile("   ########## click others radio button STARTS ###########"));
			test.clickOthersRadioBtn();
			Utilities.hardWait(2);
			Reporter.log(Utilities
					.logOutputFile("   ########## click others radio button ENDS ###########"));
			...
			Reporter.log(Utilities
					.logOutputFile("   ########## click close time to complete button STARTS ###########"));
			test.clickCloseBtn();
			Reporter.log(Utilities
					.logOutputFile("   ########## click close time to complete button ENDS ###########"));
			
			System.out.println("Outside");
			Reporter.log(Utilities
					.logOutputFile("   ########## Time to Complete ENDS ###########"));
			Reporter.log(Utilities.blankLine(""));
			Reporter.log(Utilities.blankLine(""));
	...
	public void verifyRequestOrGetInfoandEnrollNow(String CourseNameEOL, String CnameEOL) {
			...
			if (sitecoreForm.equalsIgnoreCase("n"))
		{
			...
			Reporter.log(Utilities
					.logOutputFile("   ########## Verify Request Or GetInfo and EnrollNow STARTS ###########"));
			...
			Reporter.log(Utilities
					.logOutputFile("   ########## Verify Request Or GetInfo and EnrollNow ENDS ###########"));
			Reporter.log(Utilities.blankLine(""));
			Reporter.log(Utilities.blankLine(""));
	...
	public void verifyAllSevenTabsForCourses() {
		if (program.equalsIgnoreCase("Y")) {
			Reporter.log(Utilities
					.logOutputFile("   ########## Verify Program Module (7 tabs) ENDS ###########"));
